    ...
    items: [
      {
        ...
        size: "M",
        color: "Midnight",
        image: "/maison-store/luxury-wool-coat-product-image.jpg",
      },
      {
        id: "2",
        name: "Cashmere Knit",
        ...
        size: "S",
        color: "Ivory",
        image: "/maison-store/cashmere-sweater-ivory.jpg",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        size: "S",
        color: "Pearl",
        image: "/maison-store/silk-evening-dress-pearl.jpg",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        size: "M",
        color: "Charcoal",
        image: "/maison-store/tailored-blazer-charcoal.jpg",
      },
      {
        id: "5",
        name: "Wool Trousers",
        ...
        size: "M",
        color: "Charcoal",
        image: "/maison-store/wool-trousers-charcoal.jpg",
      },
      {
        id: "6",
        name: "Silk Blouse",
        ...
        size: "S",
        color: "Ivory",
        image: "/maison-store/silk-blouse-ivory.jpg",
      },
      {
        id: "7",
        name: "Leather Belt",
        ...
        size: "M",
        color: "Black",
        image: "/maison-store/leather-belt-black.jpg",
      },
    ],
  },
]
                            ...
                            <div className="p-6 pt-0 border-t border-border">
                                ...
                                {order.items.map((item) => (
                                  <Link key={item.id} href={`/product/${item.id}`} className="flex gap-4 group">
                                    <div className="w-16 h-20 bg-muted flex-shrink-0 relative overflow-hidden">
                                      <Image
                                        src={item.image || "/maison-store/placeholder.svg"}
                                        alt={item.name}
                                        fill
                                        sizes="64px"
                                        loading="lazy"
                              ...
                              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-6 pt-6 border-t border-border">
                                ...
                                <div className="flex gap-4">
                                  <button className="text-sm underline underline-offset-4 hover:no-underline transition-all" onClick={() => toast("Opening invoice...")}>
                                    View Invoice
                                  </button>
                                  {order.status === "In Transit" && (
                                    <button className="text-sm underline underline-offset-4 hover:no-underline transition-all" onClick={() => toast("Loading tracking...")}>
                                      Track Order
                                    </button>
                                  )}
                                </div>
