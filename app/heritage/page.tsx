...
const values = [
  {
    ...
    image: "/maison-store/artisan-hands-crafting-leather-luxury-goods.jpg",
  },
  {
    ...
    image: "/maison-store/premium-leather-material-sustainable-luxury.jpg",
  },
  {
    ...
    image: "/maison-store/minimalist-luxury-handbag-timeless-design.jpg",
  },
]
...
const craftsmen = [
  {
    ...
    years: "42 years",
    image: "/maison-store/elderly-italian-craftsman-portrait-luxury.jpg",
  },
  {
    name: "Sofia Marchetti",
    role: "Lead Designer",
    years: "18 years",
    image: "/maison-store/elegant-italian-woman-designer-portrait.jpg",
  },
  {
    name: "Alessandro Rossi",
    role: "Quality Director",
    years: "28 years",
    image: "/maison-store/distinguished-italian-man-portrait-luxury.jpg",
  },
]
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative h-[70vh] lg:h-[80vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/maison-store/florence-italy-aerial-view-luxury-historic.jpg"
            alt="Florence, Italy"
            fill
            priority
            sizes="100vw"
            ...
            {values.map((value, index) => (
              ...
              >
                <div className="aspect-[5/6] overflow-hidden mb-6 relative">
                  <Image
                    src={value.image || "/maison-store/placeholder.svg"}
                    alt={value.title}
                    fill
            ...
            {craftsmen.map((person, index) => (
              ...
              >
                <div className="aspect-[4/5] overflow-hidden mb-6 grayscale hover:grayscale-0 transition-all duration-700 relative">
                  <Image
                    src={person.image || "/maison-store/placeholder.svg"}
                    alt={person.name}
                    fill
                    sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
                    loading="lazy"
